...
class TextInserter:
    ...
    def configure_pasting(self, 
        ...
        print(f"🔧 Text pasting configured: method={paste_method}, "
    ...
    def start_live_typing_mode(self):
        ...
        self.paste_thread = threading.Thread(target=self._live_pasting_processor, daemon=True)
