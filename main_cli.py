    ...
    def _start_recording(self):
        ...
        try:
            if self.audio_recorder.start_recording():
                ...
                self._print_status("Recording... Speak now! (Double-press Shift again to stop)")
            else:
                self._print_status("❌ Failed to start recording. Check microphone permissions.")
        except Exception as e:
                        ...
                        if command == 'quit':
                            ...
                            with self.state_lock:
                                ...
                                if self.last_transcribed_text:
                                    print(f"Last transcribed: '{self.last_transcribed_text}'")
                        elif command == 'help':
                            print("\nAvailable commands:")
